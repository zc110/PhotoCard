			...
			if (result == SMSSDK.RESULT_COMPLETE) {
				...
				try {
					...
					if (!TextUtils.isEmpty(des)) {
						Toast.makeText(Activity_shoujidenglu.this, des,
								Toast.LENGTH_SHORT).show();
						return;
					}
				} catch (Exception e) {
